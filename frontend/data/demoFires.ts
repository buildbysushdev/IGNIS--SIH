  ...
  "fires": [
    {
      ...
      "satellite": "SAR_RISAT_2B",
      "acq_date": "2026-09-12",
      "acq_time": "0600",
      "daynight": "D",
      "category": "FLOOD_HOTSPOT",
      "location_type": "RIVER_BASIN",
      "risk_level": "CRITICAL",
      "color": "blue",
      "facility_name": "Meenachil River Basin - Kottayam Urban Core",
      "reason": "CRITICAL: SAR satellite RISAT-2B confirms major riverine breach & flood inundation plume (+3.2m above danger level). 3 wards submerged.",
      "action": "🚨 IMMEDIATE DISPATCH: NDRF 9th Battalion Inflatable Boats & State Relief Evacuation.",
      "classification": "FLOOD_HOTSPOT",
      "response_protocol": {
        "fire_class": "Flood Level 3 Life-Threatening Inundation",
        "typical_materials": ["River Surge", "Debris Flow", "Submerged Infrastructure"],
        "use_agents": {
          "primary": ["Inflatable Rescue Boats", "Helicopter Winch Lift", "High-Flow Dewatering Pumps"],
          "secondary": ["Sandbag Levee Fortification", "Life Jackets & Throw Bags"]
        },
        "avoid": ["Entering floodwaters on foot", "Using motor vehicles in submerged corridors"],
        "equipment_required": ["Motorized Inflatable Boats (8+)", "Life Jackets (500+)", "Dewatering Pumps (12+)", "Emergency Medical Kits"],
        "safety_distance_m": 1500,
        "response_time_target_min": 10,
        "personnel_required": 45,
        "coordination": ["NDRF 9th Battalion", "Kerala State Disaster Management Authority", "District Collector Kottayam", "Indian Coast Guard"],
        "special_notes": "Meenachil River breach expanding toward Pala corridor. 85,000 residents in direct hazard perimeter.",
        "evacuation_radius_m": 2500
      }
    },
    {
      "id": "IGNIS-FLD-0002",
      ...
      "satellite": "SENTINEL_1C",
      "acq_date": "2026-09-12",
      "acq_time": "0630",
      "daynight": "D",
      "category": "FLOOD_CRITICAL",
      "location_type": "RESIDENTIAL_INUNDATION",
      "risk_level": "HIGH",
      "color": "blue",
      "facility_name": "Puthuppally Residential Submersion Zone",
      "reason": "Secondary flood wave inundating residential settlements along Pala-Changanacherry corridor. 2,400 residents stranded.",
      "action": "Helicopter winch evacuation & amphibious vehicle deployment.",
      "classification": "FLOOD_CRITICAL"
    },
    {
      "id": "IGNIS-FLD-0003",
      "latitude": 26.5775,
      ...
      "daynight": "D",
      "category": "FLOOD_HOTSPOT",
      "location_type": "RIVERINE_FLOODPLAIN",
      "risk_level": "CRITICAL",
      "color": "blue",
      "facility_name": "Brahmaputra River - Kaziranga Buffer Corridor",
      "reason": "Severe river overflow exceeding high-flood mark by 1.4m. Low-lying animal corridors and 14 villages submerged.",
      "action": "SDRF + Forest Protection Force joint boat rescue & high-ground relief camp activation.",
      "classification": "FLOOD_HOTSPOT"
    },
    {
      "id": "IGNIS-FLD-0004",
      ...
      "location_type": "URBAN_RIVER_BASIN",
      "risk_level": "HIGH",
      "color": "blue",
      "facility_name": "Yamuna Riverfront - Old Railway Bridge",
      "reason": "Hathnikund barrage discharge reaching Delhi. Yamuna water level 208.66m (above evacuation threshold).",
      "action": "Evacuate low-lying settlements along floodplain to higher ground relief camps.",
    ...
    },
    {
      ...
      "satellite": "INSAT_3D_DOPPLER",
      "acq_date": "2026-09-12",
      "acq_time": "0800",
      "daynight": "D",
      "category": "CYCLONE_HOTSPOT",
      "location_type": "CYCLONE_EYE_WALL",
      "risk_level": "CRITICAL",
      "color": "purple",
      "facility_name": "Cyclone Dana Eye-Wall Landfall - Dhamra Port",
      "reason": "CRITICAL: VSCS Cyclone Dana eye-wall making landfall. Sustained winds 185 km/h, gusts 205 km/h. Coastal storm surge 4-6m.",
      "action": "🚨 RED ALERT EMERGENCY: Mass coastal clearance. 3.2L evacuated to Pucca Cyclone Shelters. ODRAF pre-deployed.",
      "classification": "CYCLONE_HOTSPOT",
      "response_protocol": {
        "fire_class": "Tropical Cyclone Category 4 Landfall Emergency",
        "typical_materials": ["Storm Surge", "Extreme Wind Gale", "Structural Collapses"],
        "use_agents": {
          "primary": ["Storm Surge Barriers", "Tracked Amphibious Crafts", "Emergency Satellite Comms (VSAT)"],
          "secondary": ["Chainsaw Debris Clearing Teams", "Heavy Earthmovers for Embankments"]
        },
        "avoid": ["Offshore navigation", "Remaining in thatched/asbestos roofed structures"],
        "equipment_required": ["ODRAF High-Wind Tents", "Amphibious Rescue Vehicles", "Power Generators (50+)", "Satellite VSAT Terminals"],
        "safety_distance_m": 5000,
        "response_time_target_min": 5,
        "personnel_required": 120,
        "coordination": ["IMD Cyclone Warning Centre", "ODRAF Special Unit", "NDRF 2nd Battalion", "Indian Navy Eastern Command"],
        "special_notes": "Direct landfall near Dhamra Port / Bhitarkanika Mangrove sector. Extreme structural surge hazard.",
        "evacuation_radius_m": 10000
      }
    },
    {
      "id": "IGNIS-CYC-0002",
      ...
      "acq_time": "0815",
      "daynight": "D",
      "category": "CYCLONE_CRITICAL",
      "location_type": "STORM_SURGE_ZONE",
      "risk_level": "CRITICAL",
      "color": "purple",
      "facility_name": "Kendrapara Coastal Surge Barrier",
      "reason": "Severe sea water intrusion penetrating 4km inland. Saline embankment breaches reported across 34 villages.",
      "action": "Deploy tracked amphibious rescue crafts & heavy earthmovers for embankment closure.",
      "classification": "CYCLONE_CRITICAL"
    },
    {
      "id": "IGNIS-CYC-0003",
      "latitude": 21.6266,
      ...
      "daynight": "D",
      "category": "CYCLONE_HOTSPOT",
      "location_type": "CYCLONE_RAIN_BAND",
      "risk_level": "HIGH",
      "color": "purple",
      "facility_name": "Digha Coastal Defense Sector",
      "reason": "Spiral rain-band convection dumping 220mm rainfall in 6 hours. Gale wind speed 110-125 km/h.",
      "action": "NDRF 2nd Battalion standby; power grid shutdown in vulnerable coastal blocks.",
      "classification": "CYCLONE_HOTSPOT"
    },
    {
      "id": "IGNIS-CYC-0004",
      ...
      "daynight": "D",
      "category": "CYCLONE_HOTSPOT",
      "location_type": "CYCLONE_LANDFALL",
      "risk_level": "CRITICAL",
      "color": "purple",
      "facility_name": "Gulf of Kutch Coastal Corridor",
      "reason": "Extremely Severe Cyclonic Storm track impact. Marine radar detects 160 km/h wind shear & high astronomical tide.",
      "action": "Indian Coast Guard offshore patrol alert + SDRF team rapid clearing of fallen communication towers.",
      "classification": "CYCLONE_HOTSPOT"
    },
    {
      "id": "IGNIS-EM-0002",
